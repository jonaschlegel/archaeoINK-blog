...
![Figure 1: Illustration of a Kore statue in its currently displayed version, white line drawing and colourised interpretation by Jona Schlegel](/static/img/blog/ReimaginingThePast/figure1-kore-statue.jpeg)

<div className="bottom-8 text-sm">
  *Figure 1: Illustration of a Kore statue in its currently displayed version, white line drawing
  and colourised interpretation by Jona Schlegel*
</div>
...
![Figure 2: Different styles of displaying archaeological interpretations from photographs to illustrations; from left to right: Photograph of the Parthenon Western facade by Guillaume Piolle, Picture of the Parthenon Western facade by Guillaume Piolle with a sketched interpretation by Jona Schlegel, white interpretation of the Parthenon by Jona Schlegel, colourised interpretation of the Parthenon by Jona Schlegel](/static/img/blog/ReimaginingThePast/figure2-parthenon-facade.jpeg)

<div className="bottom-8 text-sm">
  *Figure 2: Different styles of displaying archaeological interpretations from photographs to
  illustrations; from left to right: Photograph of the Parthenon Western facade by Guillaume Piolle,
  Picture of the Parthenon Western facade by Guillaume Piolle with a sketched interpretation by Jona
  Schlegel, white interpretation of the Parthenon by Jona Schlegel, colourised interpretation of the
  Parthenon by Jona Schlegel*
</div>
