...
![Figure 1: Revelation of Ötzis Appearance. An artists impression of Ötzi the Iceman, comparing two versions: the older theory with light skin, light eyes, and a full head of hair, and the updated depiction showing dark skin, dark eyes, and a balding head. Snowy mountains are visible in the background](/static/img/blog/ReevaluatingSkinColour/figure1-drawing-of-oetzi.jpeg)

<div className="bottom-8 mt-2 text-sm">
...
<div className="bottom-8 mt-2 text-sm">
  *Figure 2: Latest Reconstruction of the Cheddar Man. The latest reconstruction of Cheddar Man,
  ...
  Europeans. Image by Werner Ustorf, licensed under CC BY-SA 2.0.*
</div>
