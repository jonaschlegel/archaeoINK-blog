...
images: ['/static/img/blog/VisualStoryTelling/cover-design.jpg']
layout: PostLayout
...
![Figure 1: Overview of the evolving roles of female archaeologists across time by Jona Schlegel.](/static/img/blog/VisualStoryTelling/figure1-overview-of-evolving-roles.jpg "Hand-drawn timeline diagram titled 'Female Archaeologists' showing the progression from past to future. Notes highlight questions and concepts like the evolution of tools, changing roles, and speculative ideas about future archaeological practices.")

<div className="image-caption">
  <strong>Figure 1:</strong> Overview of the evolving roles of female archaeologists across time.
...
![Figure 2: Illustration of the past archaeologist, inspired by Ann Axtell Morris by Jona Schlegel.](/static/img/blog/VisualStoryTelling/figure2-past-archaeologist.jpg 'Sketch of a female archaeologist from the 1920s, inspired by Ann Axtell Morris, seated and drawing a mural with a helmet and simple gear. Annotated text provides context about Morris’s work and struggles for recognition.')

<div className="image-caption">
  <strong>Figure 2:</strong> Illustration of the past archaeologist, inspired by Ann Axtell Morris
  by Jona Schlegel
</div>
...
![Figure 3: Present-day archaeologist depicted with modern tools by Jona Schlegel.](/static/img/blog/VisualStoryTelling/figure3-present-archaeologist.jpg 'Illustration of a modern female archaeologist wearing high-visibility work attire. She stands next to a terrestrial laser scanner, prepared for digital documentation. Notes describe the technological equipment and practical fieldwork clothing.')

<div className="image-caption">
  <strong>Figure 3:</strong> Present-day archaeologist depicted with modern tools. Illustration by
  Jona Schlegel.
</div>
...
![Figure 4: Potential future female archaeologist, with imagined advanced technology by Jona Schlegel.](/static/img/blog/VisualStoryTelling/figure4-future-archaeologist.jpg 'Concept drawing of a future female archaeologist with a sci-fi-inspired uniform and a small, hand-held device resembling a tricorder. Annotations reference influences from Star Trek and discuss the compact, efficient tools of future fieldwork.')

<div className="image-caption">
  <strong>Figure 4:</strong> Potential future female archaeologist, with imagined advanced
  technology. Illustration by Jona Schlegel.
</div>
...
![Figure 5: Colour palette used for the cover design by Jona Schlegel.](/static/img/blog/VisualStoryTelling/figure5-color-palette.jpg 'Horizontal display of colour swatches used for the cover design, showing earthy tones for the past archaeologist, bright and reflective colours for the present, and sleek, cool shades for the future archaeologist.')

<div className="image-caption">
  <strong>Figure 5:</strong> Colour palette used for the cover design by Jona Schlegel.
</div>
...
- **Lashley, M.** (2023). _Visual storytelling: Shaping narratives with pictures_, in S.M. Place & J.D. Ray (ed.) Strategic communication in the digital age: 56–78. London: Routledge. https://doi.org/10.4324/9781003411796-5
- **Newman, T. & R. Beets.** (2023). _Exploring the brand of science: implications for science communication research and practice._ Available at: https://www.tandfonline.com/doi/full/10.1080/00934690.2021.1985304 [Accessed 22 October 2024].
