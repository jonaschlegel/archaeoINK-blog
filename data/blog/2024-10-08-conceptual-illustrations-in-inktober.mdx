...
![Figure 1: Backpack. A backpack with a sitar, language dictionary, and Catholic cross peeking out, symbolising the cultural baggage we all carry.](/static/img/blog/ConceptualIllustrationInktober/figure1-prompt1.jpeg)

<div className="bottom-8 text-sm">
  *Inktober 2024 Day 1 - Prompt 1 Backpack. A backpack with a sitar, language dictionary, and
  Catholic cross peeking out, symbolising the cultural baggage we all carry.*
</div>
...
![Figure 2: Discovery](/static/img/blog/ConceptualIllustrationInktober/figure2-prompt2.jpeg)

<div className="bottom-8 text-sm">
  *Inktober 2024 Day 2 - Prompt 2 Discovery. Newspapers with sensationalist headlines, illustrating
  the media's role in shaping public perceptions of archaeology.*
</div>
...
![Figure 3: Boots](/static/img/blog/ConceptualIllustrationInktober/figure3-prompt3.jpeg)

<div className="bottom-8 text-sm">
  *Inktober 2024 Day 3 - Prompt 3 Boots. A modern hiking boot paired with an indigenous moccasin,
  symbolizing the importance of cultural empathy in archaeological interpretation.*
</div>
...
![Figure 4: Exotic](/static/img/blog/ConceptualIllustrationInktober/figure4-prompt4.jpeg)
...
![Figure 5: Binoculars](/static/img/blog/ConceptualIllustrationInktober/figure5-prompt5.jpeg)

<div className="bottom-8 text-sm">
  *Inktober 2024 Day 5 - Prompt 5 Binoculars. Old and modern binoculars, symbolizing the evolving
  focus and methodologies in archaeology.*
</div>
...
![Figure 6: Trek](/static/img/blog/ConceptualIllustrationInktober/figure6-prompt6.jpeg)

<div className="bottom-8 text-sm">
  *Inktober 2024 Day 6 - Prompt 6 Trek. Captain Picard depicted as a future archaeologist,
  reflecting on the potential expansion of archaeology into space.*
</div>
...
![Figure 7: Passport](/static/img/blog/ConceptualIllustrationInktober/figure7-prompt7.jpeg)

<div className="bottom-8 text-sm">
  *Inktober 2024 Day 7 - Prompt 7 Passport. A Roman Empire map with a passport stamp and checkpoint,
  drawing connections between ancient and modern concepts of borders and identity.
</div>
...
![Figure 8: Hike](/static/img/blog/ConceptualIllustrationInktober/figure8-prompt8.jpeg)

<div className="bottom-8 text-sm">
  *Inktober 2024 Day 8 - Prompt 8 Hike. A field survey team before a mountain range, symbolizing the
  journey of discovery in archaeology.*
</div>
...
- Newman, T. P., & Beets, B. A. (2023). "Exploring the brand of science: implications for science communication research and practice." Antiquity.
- Tildesley, S., & Coote, L. V. (2009). "This Brand is Me: A Social Identity Based Measure of Brand Identification." Antiquity.
