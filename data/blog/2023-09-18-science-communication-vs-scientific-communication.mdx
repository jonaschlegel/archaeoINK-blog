...
draft: false
summary: Exploring the nuances between science communication and scientific communication, the article sheds light on their distinct objectives, audiences, and methodologies. It aims to clarify the terms, emphasizing the importance of both in disseminating scientific knowledge effectively.
...
<div className="image-caption">
  <strong>Figure 1:</strong> An open notebook showing a diagram exploring the differences of Science
  Communication (SciCom) and Scientific Communication (SciComm). The diagram illustrates the
  different objectives, audiences, and methodologies of the two communication types. Photography and
...
![Venn Diagram of Science and Scientific Communication by Jona Schlegel](/static/img/blog/sciCom/VennDiagramSciComm.jpg)

<div className="image-caption">
  <strong>Figure 2:</strong> A Venn diagram illustrating the overlap and distinctions between
  Science Communication (SciCom) and Scientific Communication (SciComm). The diagram highlights the
  shared goal of disseminating scientific knowledge while emphasizing the different audiences and
  communication methods of the two approaches. Illustration by Jona Schlegel.
</div>
...
- **Burns, T.W., O'Connor, D.J. & Stocklmayer, S.M.** (2003). _Science communication: a contemporary definition._ Public Understanding of Science 12(2), 183-202.
- **Smith, M., Finkler, W. & Aitken, R.** (2012). _Connecting people with science: A proof-of-concept study to evaluate action-based storytelling for science communication._ Sustainability 15.15, 11655.
